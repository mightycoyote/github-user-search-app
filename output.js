...
export function displayResponse(response) {
    ...
    <div class="info-columns">
      ...
      <div class="other-info">
        ...
        <p class="other-info-text">${response.location}</p>
      </div>
      ...
      <div class="other-info">
        ...
        <p class="other-info-text"><a href="${response.blog}">Blog</a></p>
      </div>
      ...
      <div class="other-info">
        ...
        <p class="other-info-text">${response.twitter_username}</p>
      </div>
      ...
      <div class="other-info">
        ...
        <p class="other-info-text">${response.company}</p>
      </div>
    </div>
