...
export function displayResponse(response) {
    ...
    <div class="info-columns">
      ...
      <div class="other-info ${response.blog === null ? `not-available` : ''}">
        ...
        <p class="other-info-text"><a href="${response.blog || `<span>Not Available</span>`}">${response.blog}</a></p>
      </div>
      ...
      <div class="other-info ${response.twitter_username === null ? `not-available` : ''}">
        ...
        <p class="other-info-text">${response.twitter_username || `<span>Not Available</span>`}</p>
      </div>
      ...
      <div class="other-info ${response.company === null ? `not-available` : ''}">
        ...
        <p class="other-info-text">${response.company || `<span>Not Available</span>`}</p>
      </div>
    </div>
